                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach($DataTabel as $dt)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0)" onclick="ubahDataKategori({{$dt->id}})" class="btn btn-warning btn-block btn-sm" class="btn btn-warning btn-block btn-sm" data-toggle="tooltip" data-placement="bottom" title="Ubah Data Kategori"><i class="fa fa-cog"></i></a>
                                                                </td>
                                                            ...
                                                            <div class="modal fade" id="Modal4">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h4 class="modal-title">Ubah Data Kategori Produk</h4>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">&times;</span>
                                                                            </button>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <form id="Form4" action="" method="post">
                                                                                ...
                                                                                <input type="hidden" id="id_kategori4"/>
                                                                                <div class="input-group mb-3">
                                                                                    <label>Kategori Produk</label>
                                                                                    <select name="id_kategori" id="id_kategori_option" class="form-control" style="width: 100%;">
                                                                                    </select>
                                                                                </div>
                                                                                <div class="col-12">
                                                                                    <button type="submit" class="btn btn-success btn-block">Simpan Perubahan Data</button>
                                                            ...
                                                            <script>
                                                                function ubahDataKategori(id)
                                                                {
                                                                    ...
                                                                    $.ajax({
                                                                        type:"GET",
                                                                        url:"/tampil_data_kategori",
                                                                        dataType: 'JSON',
                                                                        success:function(res){
                                                                            if(res){
                                                                                $("#id_kategori_option").empty();
                                                                                $("#id_kategori_option").append('<option>---Pilih Kategori---</option>');
                                                                                $.each(res,function(id,nama_kategori){
                                                                                    $("#id_kategori_option").append('<option value="'+nama_kategori+'">'+nama_kategori+'-'+id+'</option>');
                                                                                });
                                                                            }else{
                                                                                $("#id_kategori_option").empty();
                                                                            }
                                                                    ...
                                                                    $('#id_kategori_option').change(function(){
                                                                        var data_value = $(this).val();
                                                                        $("#id_kategori4").val(data_value);
                                                                    });
                                                                    $("#Form4").submit(function (e){
                                                                        e.preventDefault();
                                                                        let id = $("#id4").val();
                                                                        let id_kategori = $("#id_kategori4").val();
                                                                        let _token = $("input[name=_token]").val();
                                                                        $.ajax({
                                                                            url:"{{route('produk.simpan_perubahan_data_kategori')}}",
                                                                            type: "PUT",
                                                                            data:{
                                                                                id:id,
                                                                            ...
                                                                            success:function(response){
                                                                                $("#Modal4").modal('hide');
                                                                                window.location = "{{route('tampil_data_produk_versi_2_oleh_admin')}}";
                                                                            }
                                                                        })
                                                                    })
                                                                }
