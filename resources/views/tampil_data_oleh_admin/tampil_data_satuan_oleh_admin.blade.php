                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            <li class="nav-item">
                                <a href="{{route('tambah_data_satuan_oleh_admin')}}" class="nav-link">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Data Satuan Produk</h5>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach($DataTabel as $dt)
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form id="Form1" action="" method="post">
                                                                                ...
                                                                                <div class="input-group mb-3">
                                                                                    <input type="text" id="nama_satuan1" class="form-control" required>
                                                                                </div>
                                                                                <div class="col-12">
                                                            ...
                                                            <script>
                                                                ...
                                                                {
                                                                    $.get('/cari_id_satuan/'+id,function(data){
                                                                        $("#id1").val(data.id);
                                                                        $("#nama_satuan1").val(data.nama_satuan);
                                                                        $("#Modal1").modal('toggle');
                                                                    })
                                                                    $("#Form1").submit(function (e){
                                                                        e.preventDefault();
                                                                        let id = $("#id1").val();
                                                                        let nama_satuan = $("#nama_satuan1").val();
                                                                        let _token = $("input[name=_token]").val();
                                                                        $.ajax({
                                                                            url:"{{route('satuan.simpan_perubahan_data')}}",
                                                                            type: "PUT",
                                                                            data:{
                                                                                id:id,
                                                                            ...
                                                                            success: (response) => {
                                                                                if (response) {
                                                                                    ...
                                                                                    $("#Modal1").modal('hide');
                                                                                    window.location = "{{route('tampil_data_satuan_oleh_admin')}}";
                                                                                }
                                                                            },
                                                                            error: function(response){
                                                                                console.log(response);
                                                                                alert('Nama Satuan telah ada');
                                                                            }
                                                                        })
                                                                    })
                                                                }
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form id="Form2" action="" method="post">
                                                                                ...
                                                                                <label>Nama Satuan *</label><br>
                                                                                <div class="input-group mb-3">
                                                                                    <input type="text" id="nama_satuan2" class="form-control" disabled>
                                                                                </div>
                                                                                <div class="col-12">
                                                            ...
                                                            <script>
                                                                function hapusData(id)
                                                                {
                                                                    $.get('/cari_id_satuan/'+id,function(data){
                                                                        $("#id2").val(data.id);
                                                                        $("#nama_satuan2").val(data.nama_satuan);
                                                                        $("#Modal2").modal('toggle');
                                                                    })
