                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            <li class="nav-item">
                                <a href="{{route('tampil_data_satuan_oleh_admin')}}" class="nav-link">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Pemasukan Data Satuan</h5>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form action="{{route('simpan_data_satuan_baru_oleh_admin')}}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <label>Nama Satuan *</label><br>
                                                    <div class="input-group mb-3">
                                                        <input type="text" name="nama_satuan" class="form-control @error('nama_satuan') is-invalid @enderror" value="{{ old('nama_satuan')}}">
                                                        @error('nama_satuan')
